 ...
 */
angular.module('actualWebApp').controller('SearchCtrl', SearchCtrl);
...
function SearchCtrl(
  ...
  function init() {
    ...
    vm.activeSortOption = _.findWhere(vm.sortOptions, {
      key: activeSortOptionKey
    });

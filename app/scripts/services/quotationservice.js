(function() {
  ...
  function quotationService(
    ...
    function localDetailUpdateWithNewValues(detail, newDetailValues) {
      ...
      detail.unitPriceWithDiscountPg1 =
        newDetailValues.unitPriceWithDiscountPg1;
      detail.unitPriceWithDiscountPg2 =
        newDetailValues.unitPriceWithDiscountPg2;
      detail.unitPriceWithDiscountPg3 =
        newDetailValues.unitPriceWithDiscountPg3;
      detail.unitPriceWithDiscountPg4 =
        newDetailValues.unitPriceWithDiscountPg4;
      detail.unitPriceWithDiscountPg5 =
        newDetailValues.unitPriceWithDiscountPg5;
    ...
    function getProductTakenStockFromRemainingDetails(
      currentDetail,
      allDetails
    ) {
      return _.reduce(
    ...
    function substractProductTakenStockFromDetail(
      detail,
      deliveries,
      productTakenStock
    ) {

(function() {
  ...
  angular.module('actualWebApp').factory('authService', authService);
        ...
        if (expiration <= new Date()) {
          ...
          userService
            ...
            .then(function(res) {
              ...
              //Happens when the route /user/profile
              if (isPrivatePath(currentPath) && $rootScope.user.invited) {
                $location.path('/');
              }
            })
            .catch(function(err) {

...
function accion(numero) {
    if (window.innerWidth >= 1200) {
        ...
        document.getElementById("widget-product-title").textContent = producto.title;
        ...
        document.getElementById("mobile-product-title").textContent = producto.title;
        document.getElementById("mobile-product-price").textContent = "$" + producto.price.toFixed(2);
        openMobileSheet();
    }
}
